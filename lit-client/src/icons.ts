...
export class IconDanger extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
@customElement('icon-cart')
export class IconCart extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export class IconWait extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export class IconLoggedOut extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export class IconLoggedIn extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
...
export class IconQuestion extends LitElement {
  override render() {
    return html`<svg
      xmlns="http://www.w3.org/2000/svg"
      width="16"
